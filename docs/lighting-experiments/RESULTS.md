...
| 4.11 | min-cost-combo | report-complete | +820% | +1639% | no (Retina Empty +14%) | yes (6 throughout) | flat-bright bulbs + un-amplified halos + global directional wash; **bloom dropped**; biggest aesthetic departure | [4.11-min-cost-combo.md](4.11-min-cost-combo.md) |
